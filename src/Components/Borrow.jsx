...
import ExcitedGirlImage from '../assets/images/excited-smiling-girl-fist-pump-hold-money-prize-winning-cash-receive-income-from-something-standing-happy-against-blue-background_clipdrop-background-removal 2.svg';
import FrameImage from '../assets/images/Frame 427320724.svg';
      ...
      <div className='d-flex'>
        ...
        <div className='borrow-main'>
          ...
          <div className="image-container">
            <img src={ExcitedGirlImage} alt="Excited girl" className='borrow-image' />
          </div>
        </div>
  {/* sec */}
        <div className='borrow-main mt-5 ms-3'>
          <div className="image-container">
            <img src={FrameImage} alt="Frame Image" className="frame-image" />
          </div>
